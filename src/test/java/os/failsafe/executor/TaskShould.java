...
class TaskShould {
    ...
    void return_false_on_cancel_if_task_is_not_cancelable_because_it_is_locked() {
        Task task = new Task("id", "parameter", "name", LocalDateTime.now(), LocalDateTime.now(), LocalDateTime.now(), null, 0, 0L);
    ...
    void return_false_on_retry_if_task_is_not_retryable() {
        Task task = new Task("id", "parameter", "name", LocalDateTime.now(), LocalDateTime.now(), null, null, 0, 0L);
    ...
    void print_its_internal_state() {
        ...
        Task task = new Task("id", "parameter", "name", dateTime, dateTime, dateTime, new ExecutionFailure(dateTime, "exceptionMsg", "stackTrace"), 0, 0L);
