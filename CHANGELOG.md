...
## [3.0.0] - 2026-02-13
### Changed
- Full internal refactor: **all code unified into a single core file**
- Cleaned up legacy and unneeded modules
...
- **Added `queue` mechanism**  
  A built‑in queuing API that allows tasks to be processed **serially** in the order submitted.
...
## [2.2.1] - 2025-08-26
### Fixed
- Jitpack build and build for Java 8 again
